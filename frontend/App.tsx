...
const AppContent: React.FC = () => {
  ...
  const [allTreatmentCourses, setAllTreatmentCourses] = useState<
    TreatmentCourse[]
  >([]);
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "refresh-treatment-courses",
      handleRefreshTreatmentCourses
    );
    return () =>
  ...
  useEffect(() => {
    ...
    if (currentUser) {
      ...
      if (location.pathname === "/login" || location.pathname === "/register") {
        console.log(
          "User on login/register page, redirecting based on role:",
          normalizedRole
        );
      ...
      if (normalizedRole === "staff") {
        if (
          ...
          if (!isPublicRoute) {
            console.log(
              "Staff user on client route, redirecting to /staff/dashboard:",
              location.pathname
            );
            navigate("/staff/dashboard", { replace: true });
            return;
      ...
      if (normalizedRole === "admin") {
        if (!location.pathname.startsWith("/admin")) {
          console.log(
            "Admin user on non-admin route, redirecting to /admin:",
            location.pathname
          );
          navigate("/admin", { replace: true });
          return;
  ...
  return (
    <div className="flex flex-col min-h-screen bg-brand-light">
      {isClientLayout && (
        <Header currentUser={currentUser} onLogout={handleLogout} allServices={allServices} />
      )}
      <main className={isClientLayout ? "pt-28 flex-grow" : "flex-grow"}>
        <Routes>
          ...
          <Route
            path="/services"
            element={<ServicesListPage allServices={allServices} />}
          />
          <Route
            path="/service/:id"
            element={
          ...
          />
          <Route
            path="/treatment-course/:id"
            element={
              <ProtectedRoute user={currentUser}>
                <TreatmentCourseDetailPage
                  currentUser={currentUser!}
                  allServices={allServices}
                />
              </ProtectedRoute>
          ...
          >
            ...
            <Route
              path="users"
              element={<UsersPage allUsers={allUsers} allTiers={allTiers} />}
            />
            ...
            <Route
              path="payments"
              element={<PaymentsPage allUsers={allUsers} />}
            />
            <Route
              path="staff"
              element={
            ...
            />
            <Route
              path="treatment-courses/:id"
              element={<AdminTreatmentCourseDetailPage />}
            />
            <Route
              path="promotions"
              element={
          ...
          >
            ...
            <Route
              path="schedule"
              element={<StaffSchedulePage currentUser={currentUser!} />}
            />
            <Route
              path="appointments"
              element={
